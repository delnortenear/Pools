...
contract DelnorteSale is PausableCrowdsale, ManagerRole {
    ...
    constructor(address payable wallet, IERC20 token) public Crowdsale(wallet, token) {
        ...
        _calendar.push(TimelockData({ time: uint256(1647957284), rates: [uint256(30), 30] }));
        _calendar.push(TimelockData({ time: uint256(1650632084), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1653224084), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1655902484), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1658494484), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1661172884), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1663851284), rates: [uint256(10), 10] }));
        _calendar.push(TimelockData({ time: uint256(1666443284), rates: [uint256(10), 10] }));
    ...
    */
    function addStage(uint256 supply, uint256 cap, uint256 rate) public virtual onlyManager returns (bool) {
        require(cap > 0, 'Swap: Cap must be greater than zero');
        require(rate > 0, 'Swap: Rate must be greater than zero');
    ...
    */
    function addCalendar(uint256 time, uint256 ratesFirst, uint256 ratesSecond) public virtual onlyManager returns (bool) {
        require(time > 0, 'Swap: Time must be greater than zero');
